    ...
    >
      ...
      <ul class="md:flex-col md:min-w-full flex flex-col list-none">
        <li class="items-center">
          ...
          >
            <i
              class="fas fa-home mr-2 text-sm {location.href.indexOf('/admin/dashboard') !== -1 ? 'opacity-75' : 'text-gray-400'}"
            ></i>
            Home
          </a>
        </li>
        ...
        <li class="items-center">
          ...
          >
            <i
              class="fas fa-handshake mr-2 text-sm {location.href.indexOf('/admin/settings') !== -1 ? 'opacity-75' : 'text-gray-400'}"
            ></i>
            Contracts
          </a>
        </li>
        ...
        <li class="items-center">
          ...
          >
            <i
              class="fas fa-money-check mr-2 text-sm {location.href.indexOf('/admin/tables') !== -1 ? 'opacity-75' : 'text-gray-400'}"
            ></i>
            Transactions
          </a>
        </li>
